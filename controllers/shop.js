...
// Adding Checkout controller to get checkout data!
exports.getCheckout = (req, res, next) => {
  ...
  req.user
    ...
    .then((user) => {
      ...
      // Here we are make and configure our sessionId for stripe!
      return stripe.checkout.sessions.create({
        // Now stripe need the payment method
        mode: "payment",
        // It need the all products with format
        ...
        cancel_url: req.protocol + "://" + req.get("host") + "/checkout/cancel", //=> http://localhost:3000/checkout/success
      });
    })
    .then((session) => {
